...
Configuration for Observability Operator

## Overview

This PolicyStack template provides configuration for Observability Operator.
...
policystack install observability-operator --version 1.0.0

# Or manually copy to your stack
cp -r versions/1.0.0/* /path/to/your/stack/observability-operator/
```
